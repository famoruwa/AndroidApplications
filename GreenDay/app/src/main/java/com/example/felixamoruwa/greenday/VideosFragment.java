...
public class VideosFragment extends Fragment {
    ...
    private void playVideo(int videoId)throws Exception
    {
        ...
        switch(videoId) {
            case R.id.BurnOutRadioButton:
                videoView.setVideoURI(Uri.parse("android.resource://" + getActivity().getPackageName() + "/" + R.raw.greenday_burnout));
                break;

            case R.id.WelcomeToParadiseRadioButton:
                videoView.setVideoURI(Uri.parse("android.resource://" + getActivity().getPackageName() + "/" + R.raw.greenday_welcometoparadise));
                break;
